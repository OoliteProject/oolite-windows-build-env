...
*/
/* Obsoleted
void objc_set_unexpected (void (*handler)(id));
*/
/*
...
/*
typedef void (*objc_unexpected_exception)(id);	// delete safely
objc_EXPORT objc_unexpected_exception objc_setUnexpectedExceptionHandler (objc_unexpected_exception new_handler);
*/
