dnl  mpn_redc_1 - from x86_64/bobcat directory for fat binary.
dnl  Generated by configure - DO NOT EDIT.

define(OPERATION_redc_1)
define(__gmpn_redc_1, __gmpn_redc_1_bobcat)
define(__gmpn_redc_1c,__gmpn_redc_1c_bobcat)
define(__gmpn_preinv_redc_1,__gmpn_preinv_redc_1_bobcat)
define(__gmpn_redc_1_cps,__gmpn_redc_1_cps_bobcat)
...
include(.././mpn/x86_64/bobcat/redc_1.asm)
