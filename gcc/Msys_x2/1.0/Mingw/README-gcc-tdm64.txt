...
OPTIONAL:
 * gcc-c++ (gcc-4.7.1-tdm64-1-c++) - C++ support
 * gcc-fortran (gcc-4.7.1-tdm64-1-fortran) - Fortran support
 * gcc-objc (gcc-4.7.1-tdm64-1-objc) - Objective-C/C++ support
 * gcc-openmp (gcc-4.7.1-tdm64-1-openmp) - OpenMP support
 ...
 * gdb (gdb-7.5-tdm64-1) - GNU source-level debugger, for x86_64-w64-mingw32
     GCC
...
license is available in "COPYING-expat.txt", and finally includes a copy of the
Python DLL, which is licensed under the terms in LICENSE-python.txt.
