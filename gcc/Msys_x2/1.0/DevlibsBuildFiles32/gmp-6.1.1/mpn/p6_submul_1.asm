dnl  mpn_submul_1 - from x86/p6 directory for fat binary.
dnl  Generated by configure - DO NOT EDIT.

define(OPERATION_submul_1)
define(__gmpn_submul_1, __gmpn_submul_1_p6)
define(__gmpn_submul_1c,__gmpn_submul_1c_p6)
define(__gmpn_preinv_submul_1,__gmpn_preinv_submul_1_p6)
define(__gmpn_submul_1_cps,__gmpn_submul_1_cps_p6)
