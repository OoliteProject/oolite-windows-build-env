dnl  mpn_mul_1 - from x86/pentium4/sse2 directory for fat binary.
dnl  Generated by configure - DO NOT EDIT.

define(OPERATION_mul_1)
define(__gmpn_mul_1, __gmpn_mul_1_pentium4_sse2)
define(__gmpn_mul_1c,__gmpn_mul_1c_pentium4_sse2)
define(__gmpn_preinv_mul_1,__gmpn_preinv_mul_1_pentium4_sse2)
define(__gmpn_mul_1_cps,__gmpn_mul_1_cps_pentium4_sse2)
...
include(.././mpn/x86/pentium4/sse2/mul_1.asm)
