dnl  mpn_add_n - from x86/p6 directory for fat binary.
dnl  Generated by configure - DO NOT EDIT.

define(OPERATION_add_n)
define(__gmpn_add_n, __gmpn_add_n_p6)
define(__gmpn_add_nc,__gmpn_add_nc_p6)
define(__gmpn_preinv_add_n,__gmpn_preinv_add_n_p6)
define(__gmpn_add_n_cps,__gmpn_add_n_cps_p6)
