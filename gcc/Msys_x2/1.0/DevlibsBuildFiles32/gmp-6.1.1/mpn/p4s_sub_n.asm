dnl  mpn_sub_n - from x86/pentium4/sse2 directory for fat binary.
dnl  Generated by configure - DO NOT EDIT.

define(OPERATION_sub_n)
define(__gmpn_sub_n, __gmpn_sub_n_pentium4_sse2)
define(__gmpn_sub_nc,__gmpn_sub_nc_pentium4_sse2)
define(__gmpn_preinv_sub_n,__gmpn_preinv_sub_n_pentium4_sse2)
define(__gmpn_sub_n_cps,__gmpn_sub_n_cps_pentium4_sse2)
...
include(.././mpn/x86/pentium4/sse2/sub_n.asm)
