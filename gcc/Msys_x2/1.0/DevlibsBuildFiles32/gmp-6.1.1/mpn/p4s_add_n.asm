dnl  mpn_add_n - from x86/pentium4/sse2 directory for fat binary.
dnl  Generated by configure - DO NOT EDIT.

define(OPERATION_add_n)
define(__gmpn_add_n, __gmpn_add_n_pentium4_sse2)
define(__gmpn_add_nc,__gmpn_add_nc_pentium4_sse2)
define(__gmpn_preinv_add_n,__gmpn_preinv_add_n_pentium4_sse2)
define(__gmpn_add_n_cps,__gmpn_add_n_cps_pentium4_sse2)
...
include(.././mpn/x86/pentium4/sse2/add_n.asm)
